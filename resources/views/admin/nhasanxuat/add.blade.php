        ...
        <div class="container px-6 mx-auto py-4">
          <form action="{{ route('nhasanxuats.store') }}" method="post" id="form-nsx-add">
            ...
            <div class="mb-6 w-full md:w-2/5 form-group">
              ...
              <input name="tenNSX" value="{{ old('tenNSX') }}"
              class="tenNSX w-full px-2 text-sm text-gray-700 border-1 border-black rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" type="text">
            ...
            <div class="mb-6 w-full md:w-2/5 form-group">
              ...
              <input name="nuocSX" value="{{ old('nuocSX') }}"
