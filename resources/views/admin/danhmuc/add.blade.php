        ...
        <div class="container px-6 mx-auto py-4">
          <form action="{{ route('danhmucs.store') }}" method="post" id="form-dm-add">
            ...
            <div class="mb-6 w-40p form-group">
              ...
              <input name="tenDM" class="tenDM w-full pl-8 pr-2 text-sm text-gray-700 border-1 border-black rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input" type="text">
