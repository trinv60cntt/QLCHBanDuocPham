                    ...
                    <table class="w-full">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Mã nhóm nhân viên</th>
                                <th class="px-4 py-3">Tên nhóm nhân viên</th>
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('vaitros.edit', ['vaiTro_id' => $vaitro->vaiTro_id]) }}"
                                            ...
                                            <a href="#"
                                                data-url="{{ route('vaitros.delete', ['vaiTro_id' => $vaitro->vaiTro_id]) }}"
