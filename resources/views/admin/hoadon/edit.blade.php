...
@section('content')
    <main class="h-full pb-16">
        ...
        <div class="container px-6 mx-auto py-4">
            <form action="{{ route('hoadons.update', ['hoaDon_id' => $hoadon->hoaDon_id]) }}" method="post" enctype="multipart/form-data">
                @csrf
            <div class="details">
                <h2 class="title-details text-center py-4">DUYỆT ĐƠN HÀNG</h2>
                <hr>
                <div class="info-details-edit mx-auto py-4">
                    <div class="row">
                        <div class="mb-6 form-group flex items-center justify-around">
                            <label for="email" class="w-2p6 block mb-2 font-bold text-gray-900 dark:text-gray-300">Số hóa đơn:</label>
                            <input name="hoaDon_id"
